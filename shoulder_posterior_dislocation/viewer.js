        ...
        // Hardcoded values
const modelFile = '../shoulder/shoulder4_v2.fbx';
const modelName = 'Posterior Dislocation';
...
if (modelName === "Posterior Dislocation") {
    document.title = "Posterior Dislocation";
...
function checkCameraDistance() {
    ...
    if (distanceToCenter < minDistance + sphere.radius) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (modelName=== "Posterior Dislocation") {
                document.getElementById('model-title').textContent= "Posterior Dislocation"|| '3D Model Viewer'; // Assign directly to modelName
            } 
